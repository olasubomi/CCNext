                ...
                <div className={styles.profile_details}>
                    ...
                    <div id='upgrade-chopChow-plan' className={styles.profile_basic_info_con}>
                        ...
                        <div className={styles.profile_basic_info}>
                            ...
                            <button className={styles.profile_button} style={{width: 'max-content', alignSelf: 'start'}}>View Plan</button>
                        </div>
                    </div>
                    ...
                    <div id='close-account' className={styles.profile_basic_info_con}>
                        ...
                        <button className={styles.profile_button} style={{width: '212px', justifySelf: 'start', background: '#F40707'}}>View Plan</button>
                    </div>
