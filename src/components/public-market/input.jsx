        ...
        <div className={styles.search2}>
            ...
            />
            {
                ...
                <div className={styles.locationDropdown}>
                    ...
                    <div>
                        <p className={styles.rowName} style={{ paddingTop: '2rem' }}>Stores found ({allStores.length})</p>
                        <div style={{ borderBottom: '1px solid rgba(0, 0, 0, 0.20)', width: '100%', marginTop: '1rem' }} />
                    </div>
                                            ...
                                            <div className={styles.row}>
                                                <div className={styles.row}>
                                                    ...
                                                    <div className={styles.row} style={{ paddingLeft: '1rem' }}>
                                                        <p className={styles.storestatus}>{elem.is_open ? 'Open' : 'Close'}</p>
                                                        <p className={styles.storetime}>{elem.opening_time}</p>
                                                    </div>
                                                </div>
                                                <div className={styles.row} style={{ paddingLeft: '3rem' }}>
                                                    <HiLocationMarker
                                                        size={19}
                                                        fill="#F47900"
                                                    />
                                                    <p className={styles.storetime}>{elem.miles_away} miles away</p>
                                                </div>
                                            </div>
                                        </div>
                                        {
