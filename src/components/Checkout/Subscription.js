  ...
  return (
    <div className={styles.box_subscription}>
        <div>
            ...
            <label>
                <input type='radio' name='subscription' value="one_time" checked={data.Subscription === "subscribe"} onChange={() => handleChange()}/>
                <p>One- Time Purchase</p>
            </label>
        </div>
        <div>
            <label>Deliver Every </label>
            <select value={data.dateOfDelivery} onChange={() => handleChange()}>
