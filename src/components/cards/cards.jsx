    ...
    return(
        <div className={styles.sugImages}>
        {
            similar?.slice(0, 6).map((elem) => (
                <div style={{ width: '100%' }}>
                    <div style={{ width: '100%' }}>
                        <Image src={elem.itemImage0} width={160} height={130} layout='responsive' style={{ boxShadow: 'rgba(0, 0, 0, 0.1) 0px 4px 12px', borderRadius: '8px' }} objectFit='cover' objectPosition='center' />
                    </div>
                    <div className={styles.flex2} style={{ width: '100%', marginTop: '.7rem' }}>
