              ...
              <div className={styles.commentRow}>
                <div className={styles.comment}>
                  <div className={styles.flex}>
                    ...
                    <h5 className={styles.username}>{elem.created_by?.last_name} {elem.created_by.first_name}</h5>
                  </div>
                  <div className={styles.flex}>
                ...
                <div className={styles.message}>
                  <div>
                    {
                      Array(5).fill('_').map((_, idx) => <GoStarFill key={idx + _} color={elem.rating > idx ? '#04D505' : 'rgba(0,0,0,0.5)'} />)
                    }
                  </div>
                  <p>{elem.message}</p>
                </div>
